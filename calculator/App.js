...
export default class App extends Component {
  ...
  addDigit = n => {
    ...
    if (n !== ".") {
      ...
      const values = [...this.state.values]; // Cria uma cópia da lista de valores atual
      values[this.state.current] = newValue; // Substitui o valor atual na posição corrente com o novo valor
      this.setState({ values }); // Atualiza o estado do componente com a lista de valores modificada
    }
  };
